...
//		input = "30-15/(9-6)";
	 ...
	 */
	public static double evaluateOneOperation(double value1, double value2, String operator) throws OperatorSymbolException{
	...
	public static double evaluatePolishNotation(List<String> arrayOutput) throws OperatorSymbolException{
	 ...
	 * to Polish Notation
	 */
	public static ArrayList<String> toPolishNotation(List<String> arrayInput) throws OperatorSymbolException{
	 ...
	 * priority
	 */
	public static byte getPriority(String s) throws OperatorSymbolException{
		switch (s) {
		case "(": return 0;
		case ")": return 0;
		case "+": return 1;
	 ...
	 * separate String 
	 */
	public static ArrayList<String> toSeparateArrayStrings(String input){
